...
// // =========================================================================
// // NUEVO: ENDPOINT CONECTADO A SUPABASE PARA ALIMENTAR EL EMULADOR EN VIVO (OPTIMIZADO)
// // =========================================================================
...
//     const balotasOrdenadas = Object.keys(conteoBalotas)
//       .map(num => ({ numero: parseInt(num), frecuencia: conteoBalotas[num] }))
//       .sort((a, b) => b.frecuencia - a.frecuencia);

//     const sbOrdenadas = Object.keys(conteoSB)
//       .map(num => ({ numero: parseInt(num), frecuencia: conteoSB[num] }))
//       .sort((a, b) => b.frecuencia - a.frecuencia);

//     let calientes = balotasOrdenadas.slice(0, 14).map(b => b.numero);
//     let frios = balotasOrdenadas.slice(-14).reverse().map(b => b.numero);
//     let sbCalientes = sbOrdenadas.slice(0, 4).map(s => s.numero);
//     let sbFrias = sbOrdenadas.slice(-4).reverse().map(s => s.numero);
