...
//   // 1. CREAMOS LAS REFERENCIAS para poder controlar el foco de cada input
...
//     // 2. LÓGICA DE SALTO AUTOMÁTICO
//     // Si el usuario escribe algo en la balota, evaluamos si debe saltar a la siguiente
//     if (value.length >= 1) {
//       // Si el número ya tiene 2 dígitos, o si es un número del 4 al 9 (que sabemos que es de un solo dígito en Baloto)
...
//         // Limpiamos el formulario pero dejamos el Tipo de Sorteo que venía
//         setFormData({ fecha: '', tipo: formData.tipo, b1: '', b2: '', b3: '', b4: '', b5: '', sb: '' });
        
//         // 3. FOCO AUTOMÁTICO AL TERMINAR: Devuelve el cursor a la Fecha para el siguiente sorteo
//         setTimeout(() => {
...
//             style={{ width: '96%', padding: '8px', fontFamily: 'inherit' }} 
//           />
//         </div>
...
//             {/* 4. ASOCIAMOS LAS REFERENCIAS A CADA INPUT */}
